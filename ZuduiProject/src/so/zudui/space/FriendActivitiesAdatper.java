...
public class FriendActivitiesAdatper extends BaseAdapter {
	
	private Context context;
	private List<Activity> friendActivities = new ArrayList<Activity>();
	...
	public FriendActivitiesAdatper(Context context, List<Activity> myActivities) {
		this.context = context;
		this.friendActivities = myActivities;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Activity myActivity = friendActivities.get(position);
