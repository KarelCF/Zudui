...
/**
 * 该类封装了用户接口，详情请参�?a href="http://open.weibo.com/wiki/API%E6%96%87%E6%A1%A3_V2#.E7.94.A8.E6.88.B7">用户接口</a>
...
public class UsersAPI extends WeiboAPI {
	...
	/**
	 * 根据用户ID获取用户信息
	 * @param uid �?��查询的用户ID�?	 * @param listener
	 */
	...
	/**
	 * 通过个�?化域名获取用户资料以及用户最新的�?��微博
	 * @param domain �?��查询的个性化域名�?	 * @param listener
	 */
	...
	/**
	 * 批量获取用户的粉丝数、关注数、微博数
	 * @param uids �?��获取数据的用户UID，多个之间用逗号分隔，最多不超过100个�?
	 * @param listener
	 */
