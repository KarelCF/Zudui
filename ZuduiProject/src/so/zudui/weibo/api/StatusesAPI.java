...
public class StatusesAPI extends WeiboAPI {
	...
	/**
	 * 返回�?��的公共微�?	 * 
	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param listener
	 */
	 ...
	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?	 * @param trim_user 返回值中user字段�?��，false：返回完整user字段、true：user字段仅返回user_id，默认为false�?	 * @param listener
	 */
	 ...
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?
	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?	 * @param listener
	 */
	 ...
	 * 获取当前登录用户及其�?��注用户的�?��微博
	 * 
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?	 * @param trim_user 返回值中user字段�?��，false：返回完整user字段、true：user字段仅返回user_id，默认为false�?	 * @param listener
	 */
	...
	/**
	 * 获取某个用户�?��发表的微博列�?	 * 
	 * @param uid �?��查询的用户ID�?	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?	 * @param trim_user 返回值中user字段�?��，false：返回完整user字段、true：user字段仅返回user_id，默认为false�?	 * @param listener
	 */
	 ...
	 * 获取用户发布的微博的ID
	 * 
	 * @param uid �?��查询的用户ID�?	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?	 * @param listener
	 */
	 ...
	 * 
	 * @param screen_name �?��查询的用户昵称�?
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param feature 过滤类型ID�?：全部�?1：原创�?2：图片�?3：视频�?4：音乐，默认�?�?	 * @param listener
	 */
	...
	/**
	 * 获取指定微博的转发微博列�?	 * 
	 * @param id �?��查询的微博ID�?	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param filter_by_author 作�?筛�?类型�?：全部�?1：我关注的人�?：陌生人，默认为0�?	 * @param listener
	 */
	...
	/**
	 * 获取当前用户�?��转发的微博列�?	 * 
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param listener
	 */
	 ...
	 * 
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param filter_by_author 作�?筛�?类型�?：全部�?1：我关注的人�?：陌生人，默认为0�?	 * @param filter_by_source 来源筛�?类型�?：全部�?1：来自微博�?2：来自微群，默认�?�?	 * @param filter_by_type 原创筛�?类型�?：全部微博�?1：原创的微博，默认为0�?	 * @param trim_user 返回值中user字段�?��，false：返回完整user字段、true：user字段仅返回user_id，默认为false�?	 * @param listener
	 */
	 ...
	 * 获取@当前用户的最新微博的ID
	 * 
	 * @param since_id 若指定此参数，则返回ID比since_id大的微博（即比since_id时间晚的微博），默认�?�?	 * @param max_id 若指定此参数，则返回ID小于或等于max_id的微博，默认�?�?	 * @param count 单页返回的记录条数，默认�?0�?	 * @param page 返回结果的页码，默认�?�?	 * @param filter_by_author 作�?筛�?类型�?：全部�?1：我关注的人�?：陌生人，默认为0�?	 * @param filter_by_source 来源筛�?类型�?：全部�?1：来自微博�?2：来自微群，默认�?�?	 * @param filter_by_type 原创筛�?类型�?：全部微博�?1：原创的微博，默认为0�?	 * @param listener
	 */
	 ...
	 * 根据微博ID获取单条微博内容
	 * 
	 * @param id �?��获取的微博ID�?	 * @param listener
	 */
	 ...
	 * @param type 获取类型�?：微博�?2：评论�?3：私信，默认�?�?	 * @param listener
	 */
	 ...
	 * @param type 获取类型�?：微博�?2：评论�?3：私信，默认�?�?	 * @param inbox 仅对私信有效，当MID类型为私信时用此参数�?：发件箱�?：收件箱，默认为0 �?	 * @param isBase62 MID是否是base62编码�?：否�?：是，默认为0�?	 * @param listener
	 */
	 ...
	 * 按天返回热门微博转发榜的微博列表
	 * 
	 * @param count 返回的记录条数，�?��不超�?0，默认为20�?	 * @param base_app 是否只获取当前应用的数据。false为否（所有数据），true为是（仅当前应用），默认为false�?	 * @param listener
	 */
	 ...
	 * 转发�?��微博
	 * 
	 * @param id 要转发的微博ID�?	 * @param status 添加的转发文本，内容不超�?40个汉字，不填则默认为“转发微博�?�?	 * @param is_comment 是否在转发的同时发表评论�?：否�?：评论给当前微博�?：评论给原微博�?3：都评论，默认为0
	 * @param listener
	 */
	 ...
	 * 根据微博ID删除指定微博
	 * 
	 * @param id �?��删除的微博ID�?	 * @param listener
	 */
	 ...
	 * @param lat 纬度，有效范围：-90.0�?90.0�?表示北纬，默认为0.0�?	 * @param lon 经度，有效范围：-180.0�?180.0�?表示东经，默认为0.0�?	 * @param listener
	 */
	 ...
	 * @param content 要发布的微博文本内容，内容不超过140个汉�?	 * @param file 要上传的图片，仅支持JPEG、GIF、PNG格式，图片大小小�?M�?	 * @param lat 纬度，有效范围：-90.0�?90.0�?表示北纬，默认为0.0�?	 * @param lon 经度，有效范围：-180.0�?180.0�?表示东经，默认为0.0�?	 * @param listener
	 */
	 ...
	 * @param content 要发布的微博文本内容，内容不超过140个汉�?	 * @param file 要上传的图片，仅支持JPEG、GIF、PNG格式，图片大小小�?M�?	 * @param listener
	 */
	 ...
	 * @param imageUrl 图片的URL地址，必须以http�?���?	 * @param pic_id 已经上传的图片pid，多个时使用英文半角逗号符分隔，�?��不超过九张�?
	 * imageUrl �?pic_id必�?�?��，两个参数都存在时，取picid参数的�?为准�?	 * @param lat 纬度，有效范围：-90.0�?90.0�?表示北纬，默认为0.0�?	 * @param lon 经度，有效范围：-180.0�?180.0�?表示东经，默认为0.0�?	 * @param listener
	 */
	...
	/**
	 * 获取微博官方表情的详细信�?	 * 
	 * @param type 表情类别，face：普通表情�?ani：魔法表情�?cartoon：动漫表情，默认为face�?	 * @param language 语言类别，cnname：简体�?twname：繁体，默认为cnname�?	 * @param listener
	 */
